...
const CompanyViewDashboard = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Use a real taskId value instead of "task-123"
      // This should be a numeric value matching the backend expectation
      setSelectedTaskId("9443"); // Set to actual task ID - typically this would come from API
      setSelectedApplicationId("9443"); // Set to actual application ID
    }, 1200);
  }, []);
  ...
  return (
    <div className="px-6 py-8 space-y-8 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 xl:gap-6">
        ...
        {/* Add a new QuickStatCard for Applicants with RazorpayPayment */}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center mt-3">
                    <Button 
                      ...
                      onClick={() => handleViewApplicants(selectedTaskId)}
                    >
                      View Applications
                    </Button>

                    {/* RazorpayPayment component with taskId prop */}
                    {selectedTaskId && selectedApplicationId && (
                      <div className="ml-2">
                        <RazorpayPayment 
                          applicationId={selectedApplicationId}
                          taskId={selectedTaskId} // Pass the actual task ID
