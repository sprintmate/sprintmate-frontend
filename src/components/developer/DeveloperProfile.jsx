...
const DeveloperProfile = ({ developer }) => {
  ...
  const devProfile = developer.developerProfiles && developer.developerProfiles.length > 0 
    ? developer.developerProfiles[0] 
    : null;
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-400 h-48 relative">
          ...
          <div className="absolute -bottom-16 left-8 flex items-end">
            <div className="w-32 h-32 rounded-full bg-white p-1 shadow-md">
              {devProfile?.portfolio?.PROFILE_PIC ? (
                <img 
                  src={`/api/files/${devProfile.portfolio.PROFILE_PIC}`}
                  alt="Profile"
                  ...
                  {devProfile?.resume && (
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <a 
                          href={`/api/files/${devProfile.resume}`}
                          target="_blank"
