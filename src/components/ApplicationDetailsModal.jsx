        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2 border-l-4 border-blue-500 pl-3">
                  Task Details
                </h3>
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                  <h4 className="text-xl font-medium mb-2 text-gray-800 dark:text-white">{task.title}</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">{task.description}</p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Budget</p>
                      <p className="font-medium text-gray-800 dark:text-gray-200">{task.budget} {task.currency}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Deadline</p>
                      <p className="font-medium text-gray-800 dark:text-gray-200">{formatDate(task.deadline)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Category</p>
                      <p className="font-medium text-gray-800 dark:text-gray-200 uppercase">{task.category}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Status</p>
                      <p className="font-medium text-gray-800 dark:text-gray-200">{task.status}</p>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2 border-l-4 border-green-500 pl-3">
                  Developer Profile
                </h3>
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-gray-800 dark:text-white">{developer.name}</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{developer.email}</p>
                    </div>
                  </div>
                  <div className="flex space-x-4">
                    {developer.github && (
                      <a href={developer.github} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
                        <FaGithub className="h-5 w-5" />
                      </a>
                    )}
                    {developer.linkedin && (
                      <a href={developer.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
                        <FaLinkedin className="h-5 w-5" />
                      </a>
                    )}
                    {developer.resume && (
                      <a href={developer.resume} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
              ...
              {/* Application details */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2 border-l-4 border-purple-500 pl-3">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                  <div className="flex justify-between items-center mb-4">
                    <div>
                      ...
                      <p className="font-medium text-gray-800 dark:text-gray-200">{formatDate(createdAt)}</p>
                    </div>
                    <div>
                  ...
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Proposal</p>
                    <div className="p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-md">
                      <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{proposal}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {isWithdrawConfirmOpen && (
              ...
              >
                <motion.div
                  ...
                  onClick={(e) => e.stopPropagation()} // Prevent clicks from bubbling up
                >
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">Confirm Withdrawal</h3>
